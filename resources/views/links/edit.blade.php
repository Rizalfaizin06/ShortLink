...
@section('content')
    <div
        ...
        <form class="space-y-6" method="POST" action="{{ route('links.update', $link->id) }}">
            @csrf
            @method('PUT')
            @csrf
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">Edit Short Link</h5>
            @if ($errors->any())
            ...
            <div>
                ...
                <input type="text" name="url_title" id="url_title"
                    ...
                    placeholder="Cybersecurity Class" required value="{{ old('url_title', $link->url_title) }}" />
            ...
            <div>
                ...
                <input type="text" name="original_url" id="original_url"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                    placeholder="https://meet.google.com/xxx-xxx-xx" required
            ...
            <div class="flex md:flex-cols-3 md:gap-6 align-items-center justify-items-center -mt-5">
                ...
                <input type="text" name="custom_slug" id="custom_slug" placeholder="Cybersecurity"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                    value="{{ old('custom_slug', $link->slug) }}" />
